...
from embient.config import COLORS, console
...
async def list_threads_command(
    ...
    """CLI handler for: embient threads list."""
    ...
    if not threads:
        ...
        console.print("[dim]Start a conversation with: embient[/dim]")
        return
...
async def delete_thread_command(thread_id: str) -> None:
    """CLI handler for: embient threads delete."""
