...
from embient.shell import ShellMiddleware
...
def create_cli_agent(
    ...
    *,
    ...
    Args:
        ...
        mode: Agent mode - "code" for general coding or "trading" for Deep Analysts.
    ...
    if mode == "trading":
        # Trading mode: Use Deep Analysts orchestrator
