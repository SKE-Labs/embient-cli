...
from embient.auth import load_credentials
    ...
    async def _handle_command(self, command: str) -> None:
        ...
        if cmd in ("/quit", "/exit", "/q"):
            ...
            try:
                ...
                await self._mount_message(SystemMessage(f"embient version: {__version__}"))
            except Exception:
                await self._mount_message(SystemMessage("embient version: unknown"))
        elif cmd == "/clear":
